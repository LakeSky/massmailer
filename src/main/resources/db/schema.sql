...
CREATE TABLE "EMAIL_CONTENT"  ( 
	"ID"               	INTEGER  GENERATED ALWAYS AS IDENTITY NOT NULL,
	"EMAIL_VARIABLES"            BLOB ,
	CONSTRAINT "emailcnt_px" PRIMARY KEY("ID")
...
CREATE TABLE "EMAIL"  ( 
	...
	REFERENCES "EMAIL_FOLDER"("ID"),
        CONSTRAINT "emailcnt_fk"
	FOREIGN KEY("EMAIL_CONTENT")
	REFERENCES "EMAIL_CONTENT"("ID"),
        CONSTRAINT "emailst_fk"
	FOREIGN KEY("EMAIL_STATUS")
